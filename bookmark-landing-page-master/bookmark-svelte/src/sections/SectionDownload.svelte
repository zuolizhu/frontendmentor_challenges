  ...
  <div class="container">
    ...
    <div class="download__cards">
      <div class="download__card">
        <div class="download__card__icon">
        ...
        <p class="t-body2 download__card__version">Minimum version 62</p>
        <a href="./" class="button button--add">Add & Install Extension</a>
      </div>
      <div class="download__card">
        <div class="download__card__icon">
        ...
        <p class="t-body2 download__card__version">Minimum version 55</p>
        <a href="./" class="button button--add">Add & Install Extension</a>
      </div>
      <div class="download__card">
        <div class="download__card__icon">
        ...
        <p class="t-body2 download__card__version">Minimum version 46</p>
        <a href="./" class="button button--add">Add & Install Extension</a>
      </div>
    </div>
  </div>
